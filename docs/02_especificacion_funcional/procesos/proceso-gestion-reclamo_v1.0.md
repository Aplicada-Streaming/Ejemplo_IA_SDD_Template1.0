> ⚠️ **DOCUMENTO FUERA DE CONTEXTO** — Este documento pertenece al proyecto "Sistema de Gestión de Reclamos Ciudadanos" y fue incluido por error en la documentación del Motor DSL. Pendiente de remoción o reubicación.
